...
/**
 * Class to measure and draw the time in the {@link com.android.deskclock2.CircleTimerView}.
...
public class CountingTimerView extends View {
    ...
    static class Hundredths extends UnsignedTime {
         ...
         * {@link UnsignedTime#draw(Canvas, String, float, float)}
         */
        @Override
        public float draw(Canvas canvas, final String time, float x, float y) {
     ...
     * {@link com.android.deskclock2.CircleTimerView#onDraw(Canvas)}
     */
